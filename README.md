...
[Releases ページ](https://github.com/KITA-DS12/artifact-shelf/releases) から OS に対応したインストーラをダウンロードしてください。
...
- `Artifact Shelf_<version>_x64_en-US.msi` または `Artifact Shelf_<version>_x64-setup.exe`
